...
function SectionTimeline() {
    const contentStyle = 'rgb(33, 150, 243, 0.0)'
    return (
        <>        
            ...
            <Container> 
                ...
                >
                    <VerticalTimelineElement                        
                        contentStyle={{ background: contentStyle, color: 'orange' }}
                        date="now"
                        contentArrowStyle={{color: 'orange'}}
                        iconStyle={{ background: '#0b1011', color: 'orange' }}
                        icon={< TbSchool/>}
                    >
                        <h3 className="vertical-timeline-element-title">Undertaking a master's degree</h3>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement                        
